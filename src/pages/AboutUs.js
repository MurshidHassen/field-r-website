        ...
        return (
            <React.Fragment>
                <FieldRNavbar></FieldRNavbar>
                    ...
                    <p style={{paddingLeft: "20px", paddingRight: "20px"}}><img src={FieldR} alt="description of image" style={{ float: "left" }} className="img-about" /><h3 style={{ textAlign: "justify", fontSize: 26 }}>FieldR is a recent startup in the field of
