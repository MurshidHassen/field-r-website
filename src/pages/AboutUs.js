            ...
            <React.Fragment>
                ...
                <Container>
                    <Row>
                        ...
                        <Col>
                            <Card style={{
                                paddingLeft: "40px", paddingRight: "40px", boxShadow: "0 4px 8px 0 rgba(0,0,0,0.2)",
                                transition: "0.3s"
...
maintaining a record of your team’s progress.</h3>
                    ...
                    <Row>
                        <Col>
                            <Card style={{
                                paddingLeft: "40px", paddingRight: "40px", textAlign: "justify", fontSize: 20, boxShadow: "0 4px 8px 0 rgba(0,0,0,0.2)",
                                transition: "0.3s"
                            }}>FieldR targets the cricket arena of Sri Lanka, ranging from national teams to schools and Clubs
